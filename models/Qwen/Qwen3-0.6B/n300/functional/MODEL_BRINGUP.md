# MODEL_BRINGUP.md — Qwen3 0.6B (n300 functional)

## Overview
This is a minimal TTNN bringup of `Qwen/Qwen3-0.6B` for N300 using 1D tensor parallel.
It is designed to be easy to read and to serve as a template for future bringups.

- Model code: `models/Qwen/Qwen3-0.6B/n300/functional/model.py`
