...
"""
Simple ALLaM 7B Instruct preview implementation in ttnn with 1D tensor parallel on T3000.
"""
...
class TtnnALLaMForCausalLM(torch.nn.Module, GenerationMixin):
    """
    ALLaM model with 100% ttnn execution and 1D tensor parallel on T3000.
