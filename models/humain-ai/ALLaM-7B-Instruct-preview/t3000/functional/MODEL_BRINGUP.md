# MODEL_BRINGUP.md — ALLaM 7B Instruct preview (t3000 functional)

## Overview
This is a minimal TTNN bringup of `humain-ai/ALLaM-7B-Instruct-preview` for T3000 using 1D tensor parallel.
It is designed to be easy to read and to serve as a template for future bringups.

- Model code: `models/humain-ai/ALLaM-7B-Instruct-preview/t3000/functional/model.py`
