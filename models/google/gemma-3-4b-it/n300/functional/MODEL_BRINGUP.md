# MODEL_BRINGUP.md — Gemma 3 4B IT (n300 functional)

## Overview
This is a minimal TTNN bringup of `google/gemma-3-4b-it` for N300 using 1D tensor parallel.
It is designed to be easy to read and to serve as a template for future bringups.

- Model code: `models/google/gemma-3-4b-it/n300/functional/model.py`
