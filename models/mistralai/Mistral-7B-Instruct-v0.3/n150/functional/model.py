...
"""
Simple Mistral 7B Instruct v0.3 implementation in ttnn - 100% device execution.

This demonstrates a minimal bringup for Mistral with all compute on device.
...
class TtnnMistralForCausalLM(torch.nn.Module, GenerationMixin):
    """
    Mistral model with 100% ttnn execution.
