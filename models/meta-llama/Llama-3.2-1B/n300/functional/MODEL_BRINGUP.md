# MODEL_BRINGUP.md — Llama 3.2 1B (n300 functional)

## Overview
This is a minimal TTNN bringup of `meta-llama/Llama-3.2-1B` for N300 using 1D tensor parallel.
The code is intentionally simple and mirrors the n150 functional model while sharding key matmuls.

- Model code: `models/meta-llama/Llama-3.2-1B/n300/functional/model.py`
...
```
python eval.py models/meta-llama/Llama-3.2-1B/n300/functional/model.py
```

On this N300 host, set the mesh to devices 0 and 2:

```
TT_VISIBLE_DEVICES=0,2 python eval.py models/meta-llama/Llama-3.2-1B/n300/functional/model.py
```
